...
Comenzamos la semana hablando de una [publicación](https://journals.plos.org/plosbiology/article?id=10.1371/journal.pbio.3000673) reciente que ilustra de forma muy clara cómo se puede usar la teoría de evolución molecular que hemos estudiado en el curso para poner a prueba hipótesis similares a aquellas de teorías de la conspiración que hemos visto circular en estos tiempos en cuanto a que el coronavirus habría "escapado" de un laboratorio en China. El estudio muestra evidencia filogenética bastante convincente de que los virus causantes de un brote de la enfermedad de la lengua azul que afectó bovinos en 2015 fueron derivados de virus de un brote que existió en la década anterior. Además, debido a que los virus de ambas épocas muestran patrones de evolución molecular que indican acumulación de sustituciones a una tasa constante en cada época pero ausencia de cambios genéticos entre épocas, resulta claro que la evolución del virus estuvo congelada por años (probablemente en un laboratorio) hasta que el virus "se escapó" y empezó a circular nuevamente entre animales y a evolucionar a una tasa constante. No sobra decir que no hay ninguna evidencia de este tipo para el caso de SARS-Cov2.
...
Finalmente, tuvimos un examen en el que los estudiantes respondieron algunas preguntas de opción múltiple y una [pregunta](https://github.com/cdanielcadena/evolucion/blob/master/parcial.pdf) abierta en la que debían aplicar su conocimiento para evaluar [información](https://www.biorxiv.org/content/10.1101/2020.04.29.069054v1) aparecida en los últimos días sobre una supuesta nueva cepa más "peligrosa" de SARS-Cov2 que habría desarrollado mayor transmisibilidad debido a una mutación particular.

Había varias maneras de contestar correctamente la pregunta. Yo diría muy brevemente que si bien el patrón de incremento en un genotipo es claro y podría ser evidencia de un incremento en transmisibilidad del virus, hay otras explicaciones que no pueden descartarse. En particular, es posible que esa variante genética haya incrementado en frecuencia simplemente por efectos estocásticos (i.e. deriva genética) asociados con que hubo varias introducciones de virus con este genotipo desde China hacia Europa y de allí a otros lugares del mundo, sin que haya habido cambio alguno en transmisibilidad. Para una consideración mucho más detallada del problema, recomiendo este muy buen artículo de Ed Yong en [The Atlantic](https://www.theatlantic.com/health/archive/2020/05/coronavirus-strains-transmissible/611239/) y esta nota breve de Carl Zimmer en [The New York Times](https://www.nytimes.com/2020/05/06/health/coronavirus-mutation-transmission.html). También recomiendo este [podcast](https://www.theatlantic.com/health/archive/2020/05/dont-worry-about-a-new-strain/611308/) en el que entrevistan a Yong. (Nota al margen: Como era de esperarse por su rigurosidad y enorme talento como divulgadores científicos, me parece que la labor que Yong y Zimmer están haciendo en esta época en que la gente necesita buena información ha sido absolutamente vital.)

Un punto bien interesante es que un análisis preliminar hecho por el grupo de [Trevor Bedford](https://github.com/blab/ncov-D614G) efectivamente señala que los virus con la nueva mutación podrían estarse replicando mejor que los virus con el genotipo ancestral, como lo evidencia una mayor carga viral y una edad de infección menor en pacientes afectados con virus que tienen la mutación nueva. Habrá que ver si estudios futuros apoyan esta idea. Un detalle muy llamativo es que la nueva mutación no es única sino que ha aparecido varias veces independientemente en la historia del virus desde que comenzó la epidemia. Pregunta abierta para los estudiantes y demás personas que han estado pendientes del curso: ¿podrían usarse esas réplicas evolutivas de aparición repetida de la misma mutación para poner a prueba la hipótesis de que esta mutación incrementa la transmisibilidad? ¿Qué predicciones de dicha hipótesis podrían evaluarse dado el patrón que sugiere la [filogenia](https://github.com/blab/ncov-D614G/blob/master/figures/nextstrain_d614g_2020-05-01.PNG)? Nuestras clases sobre el estudio de adaptación en un contexto filogenético dan algunas pistas para contestar estas preguntas y más adelante en el curso hablaremos de herramientas para el estudio de macroevolución que podrían también ser aplicables.
